...
multi-D eq complexity: 24, flux_norm loss: 0.554

| param | in subset? | GP σ | hybrid σ | hybrid/GP ratio |
|---|---|---|---|---|
| tau0 | GP-slice | 0.0159 | 0.0183 | **1.15×** |
| ns | ✓ multi-D | 0.0258 | 0.0383 | **1.49×** |
| Ap | ✓ multi-D | 0.11 | nan | **nan×** |
| herei | ✓ multi-D | 0.0677 | nan | **nan×** |
| heref | ✓ multi-D | 0.206 | 5.03e+06 | **24383907.53×** |
| alphaq | ✓ multi-D | 0.241 | 0.143 | **0.59×** |
| hub | GP-slice | 0.00591 | 0.00588 | **0.99×** |
| omegamh2 | GP-slice | 0.000956 | 0.000946 | **0.99×** |
| hireionz | ✓ multi-D | 0.675 | 0.657 | **0.97×** |
| bhfeedback | GP-slice | 0.00468 | 0.00473 | **1.01×** |

## Target subset ('Ap', 'ns', 'tau0', 'dtau0')
  - **Ap**: ratio = nan× (multi-D)
  - **ns**: ratio = 1.49× (multi-D)
  - **tau0**: ratio = 1.15× (GP-slice)

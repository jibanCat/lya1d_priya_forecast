...
| herei | 19 | 13.5 | 1.00% | 2.60% | 6.97% | 14.11% | ✓ | ✓ |
| heref | 19 | 6.12 | 0.92% | 1.83% | 8.67% | 7.52% | ✗ | ✓ |
| alphaq | 20 | 16.2 | 0.78% | 2.59% | 13.85% | 25.28% | ✓ | ✓ |
...
### `herei`  (θ_fid = 4, complexity = 19, flux_norm loss = 13.5)

```
((-4.6036716 - exp(4.438199 * ((r - z) - square(k)))) * r) + ((2.2928627 - z) + θ)
```

### `heref`  (θ_fid = 2.765, complexity = 19, flux_norm loss = 6.12)

```
(exp(square((r - square(k)) / 0.67056626)) * ((r * -3.8514104) + square(k - z))) + 2.0712063
```

### `alphaq`  (θ_fid = 1.74, complexity = 20, flux_norm loss = 16.2)

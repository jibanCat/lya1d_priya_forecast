...
def render_grid(fronts_by_param, out_path, *, gate_tol=GATE_TOL,
    ...
    y_col: which front column to put on the (log) y-axis. "Loss" is the raw
    PySR training loss (not comparable across objectives); "value_mse" is the
    common emulator-grounded value loss (comparable).
    """
